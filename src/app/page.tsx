  ...
  return (
    <div className="flex-grow bg-bg-primary text-slate-100 flex flex-col overflow-x-hidden">
      ...
      <section className="relative overflow-hidden pt-36 sm:pt-44 lg:pt-48 pb-24 sm:pb-32 lg:pb-36">
        ...
        <div className="relative w-full max-w-[1280px] mx-auto px-6 sm:px-8 md:px-16 lg:px-20 z-10">
          <div className="flex flex-col items-center text-center space-y-24">
            
            {/* Centered Text Content */}
            <div className="space-y-12 flex flex-col items-center max-w-4xl">
              ...
              <div className="flex flex-wrap items-center justify-center gap-6 pt-2">
                {[
                  ...
                  return (
                    <div key={item.text} className="flex items-center justify-center gap-2.5 bg-surface/60 border border-white/5 text-slate-300 px-5 py-3.5 rounded-2xl text-sm font-semibold shadow-sm">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-6 pt-12 w-full">
                <a
                  href="https://konfhub.com/arvix-nexus-2026-national-level-innovation-hackathon"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-3 px-10 py-5 bg-gradient-to-r from-primary to-secondary hover:opacity-95 text-white rounded-2xl font-bold text-lg shadow-xl shadow-primary/20 hover:shadow-primary/30 transition-all duration-300 hover:-translate-y-0.5"
                >
                ...
                <a
                  href="#about"
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-3 px-10 py-5 border border-white/10 hover:border-white/20 bg-slate-900/40 hover:bg-slate-800/60 text-slate-200 hover:text-white rounded-2xl font-bold text-lg transition-all duration-300 hover:-translate-y-0.5"
                >
            ...
            <div className="flex flex-wrap justify-center gap-8 w-full max-w-5xl pt-16">
              <div className="glass-card card-padding gradient-border-glow animate-float flex-1 w-full sm:w-auto sm:min-w-[320px] flex flex-col items-center text-center">
                <Star className="w-6 h-6 text-warning mb-4 animate-pulse" />
                <span className="text-xs font-bold uppercase tracking-widest text-primary mb-3">Venue & Host</span>
                <h3 className="text-xl font-extrabold text-white leading-tight">Lovely Professional University</h3>
                <p className="text-sm text-slate-400 mt-3">Grand Trunk Road, Phagwara, Punjab, India.</p>
              </div>

              <div className="glass-card card-padding gradient-border-glow animate-float-delayed flex-1 w-full sm:w-auto sm:min-w-[320px] flex flex-col items-center text-center">
                <Trophy className="w-6 h-6 text-secondary mb-4" />
                <h4 className="text-xl font-extrabold text-white mb-3">Innovation Battle</h4>
                <p className="text-sm text-slate-400 mb-4">Cash prizes, certificates & developer goodies</p>
                <span className="bg-primary/10 text-primary border border-primary/15 px-4 py-1.5 rounded-full font-bold text-xs">36 Hours (Continuous)</span>
              </div>
            </div>
          ...
          <div className="pt-24 mt-16 border-t border-white/5">
            <div className="grid grid-cols-2 md:grid-cols-5 gap-6 sm:gap-8 text-center max-w-6xl mx-auto">
              {[
                ...
                <div key={i} className="space-y-2 py-6 px-4 glass-card border border-white/5 bg-surface/20 premium-hover-lift">
                  <span className="block text-3xl md:text-4xl font-extrabold text-white tracking-tight bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">{stat.value}</span>
                  <span className="block text-xs uppercase font-bold text-slate-500 tracking-wider mt-2">{stat.label}</span>
                </div>
              ))}
            </div>
          </div>
      ...
      {/* Countdown section */}
      <section className="relative z-10 w-full max-w-[1280px] mx-auto px-6 sm:px-8 md:px-16 lg:px-20 mb-24">
        <div className="glass-card gradient-border-glow p-8 sm:p-12 flex flex-col items-center text-center gap-10 bg-surface/40 max-w-5xl mx-auto">
          <div className="space-y-4 max-w-2xl flex flex-col items-center">
            <div className="flex items-center gap-3">
              <Clock className="w-6 h-6 text-primary animate-pulse" />
              <h3 className="text-lg font-extrabold text-white uppercase tracking-widest">Time Remaining Until Kickoff</h3>
            </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 sm:gap-8 pt-4">
            {countdownUnits.map((unit, i) => (
              <div key={unit.label} className="flex items-center gap-6 sm:gap-8">
                <div className="flex flex-col items-center">
                  <div className="flex items-center justify-center w-24 h-24 sm:w-28 sm:h-28 rounded-3xl bg-surface border border-white/5 text-4xl sm:text-5xl font-extrabold text-primary tabular-nums shadow-inner">
                    {String(unit.value).padStart(2, '0')}
                  </div>
                  <span className="text-xs sm:text-sm uppercase font-bold tracking-widest text-slate-500 mt-4">{unit.label}</span>
                </div>
                {i < countdownUnits.length - 1 && (
                  <span className="text-slate-700 text-4xl font-bold hidden xs:inline pb-10">:</span>
                )}
              </div>
            ))}
          </div>
          ...
          <div className="pt-10 w-full">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-3 px-10 py-5 bg-white/5 hover:bg-primary/20 border border-primary/30 hover:border-primary/60 text-white rounded-2xl font-bold text-lg shadow-md transition-all hover:-translate-y-0.5"
            >
              <span>Claim Your Spot Before Time Runs Out</span>
      ...
      <section id="about" className="section-py relative z-10 border-t border-white/5">
        <div className="w-full max-w-[1280px] mx-auto px-6 sm:px-8 md:px-16 lg:px-20">
          <div className="flex flex-col items-center text-center space-y-24 max-w-5xl mx-auto">
            
            <div className="space-y-8 flex flex-col items-center">
              <div className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-primary bg-primary/10 px-5 py-2 rounded-full border border-primary/20">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 w-full">
              {[
                ...
                <div key={i} className={`glass-card p-8 border flex flex-col items-center text-center justify-center space-y-4 premium-hover-lift ${stat.color}`}>
                  <h4 className="text-2xl font-black text-white leading-tight">{stat.title}</h4>
            ...
            <div className="pt-12 w-full flex justify-center">
              <a
                href="#themes"
                className="inline-flex items-center justify-center gap-3 px-10 py-5 bg-gradient-to-r from-primary to-secondary hover:opacity-95 text-white rounded-2xl font-bold text-base shadow-xl shadow-primary/20 hover:-translate-y-0.5 transition-all"
              >
      ...
      <section id="themes" className="section-py relative z-10 bg-surface/30 border-y border-white/5">
        <div className="w-full max-w-[1280px] mx-auto px-6 sm:px-8 md:px-16 lg:px-20">
          <div className="flex flex-col items-center text-center mb-20 space-y-8 max-w-3xl mx-auto">
            <div className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-primary bg-primary/10 px-5 py-2 rounded-full border border-primary/20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 max-w-6xl mx-auto">
            {HACKATHON_THEMES.map((theme, i) => {
              ...
              return (
                <div key={i} className="glass-card p-10 border border-white/5 flex flex-col items-center text-center space-y-8 hover:border-primary/30 transition-all duration-300 group premium-hover-lift h-full justify-center">
                  <div className="flex flex-col items-center space-y-6">
                    <div className="flex items-center gap-2 text-xs font-bold uppercase tracking-wider">
                      <span className="text-primary bg-primary/10 border border-primary/20 px-4 py-1.5 rounded-full">{theme.category}</span>
                    </div>

                    <div className={`w-20 h-20 rounded-3xl flex items-center justify-center border ${theme.color} group-hover:scale-110 transition-transform duration-300`}>
                    ...
                    <p className="text-base text-slate-400 leading-relaxed">{theme.desc}</p>

                    <div className="pt-4">
                      <span className="text-slate-400 bg-white/5 border border-white/10 px-4 py-2 rounded-full text-xs font-bold uppercase">Difficulty: {theme.difficulty}</span>
                    </div>
                  </div>
                </div>
              );
          ...
          <div className="mt-24 flex justify-center w-full">
            <a
              href="#timeline"
              className="inline-flex items-center justify-center gap-3 px-10 py-5 bg-white/5 hover:bg-primary/20 border border-primary/30 hover:border-primary/60 text-white rounded-2xl font-bold text-base shadow-md transition-all hover:-translate-y-0.5"
            >
      ...
      <section id="timeline" className="section-py relative z-10">
        <div className="w-full max-w-[1280px] mx-auto px-6 sm:px-8 md:px-16 lg:px-20">
          <div className="flex flex-col items-center text-center mb-24 space-y-8 max-w-3xl mx-auto">
            <div className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-primary bg-primary/10 px-5 py-2 rounded-full border border-primary/20">
          ...
          <div className="relative space-y-12 max-w-3xl mx-auto flex flex-col items-center">
            ...
            {UNIFIED_TIMELINE.map((item, idx) => {
              return (
                <div key={idx} className="relative z-10 flex flex-col items-center w-full group">
                  {/* Timeline Node */}
                  <div className="w-12 h-12 rounded-full bg-slate-900 border-[5px] border-primary flex items-center justify-center shadow-[0_0_20px_rgba(79,124,255,0.5)] group-hover:scale-110 transition-transform mb-8 z-20">
                    <span className="text-white text-sm font-bold">{idx + 1}</span>
                  </div>
                  
                  {/* Timeline Card - Center aligned */}
                  <div className="w-full glass-card p-6 sm:p-10 border border-white/5 flex flex-col items-center text-center premium-hover-lift bg-surface/80">
                    <div className="flex flex-wrap items-center justify-center gap-4 mb-5">
                      <span className="text-sm font-bold text-primary tracking-widest uppercase bg-primary/10 border border-primary/25 px-4 py-1.5 rounded-full">{item.time}</span>
                      <span className="text-sm font-bold text-slate-400 uppercase bg-white/5 px-4 py-1.5 rounded-full">Day {item.day}</span>
                    </div>
                    <h4 className="text-2xl font-extrabold text-white mb-4 leading-snug">{item.title}</h4>
                    <p className="text-base text-slate-400 leading-relaxed max-w-xl mx-auto">{item.desc}</p>
                  </div>
                </div>
              );
            })}
        ...
        <div className="w-full max-w-[1280px] mx-auto px-6 sm:px-8 md:px-16 lg:px-20">
          <div className="flex flex-col items-center text-center space-y-24 max-w-5xl mx-auto">
            ...
            <div className="space-y-8 flex flex-col items-center">
              ...
              <p className="body-text text-slate-350 leading-relaxed mx-auto max-w-[700px]">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-10 w-full">
              <div className="glass-card p-10 flex flex-col items-center text-center w-full md:w-1/2">
                <div className="w-16 h-16 rounded-2xl bg-primary/10 flex items-center justify-center text-primary mb-6">
                  <Building2 className="w-8 h-8" />
                </div>
                <h4 className="text-xl font-bold text-white mb-3">Full Address</h4>
                <p className="text-base text-slate-400 leading-relaxed">Lovely Professional University, Grand Trunk Road, Phagwara, Punjab, 144411, India.</p>
              </div>
              ...
              <div className="glass-card p-10 flex flex-col items-center text-center w-full md:w-1/2">
                ...
                <h4 className="text-xl font-bold text-white mb-3">How to Reach</h4>
                <p className="text-base text-slate-400 leading-relaxed">Easily accessible by train via Phagwara Junction or Jalandhar City Railway Stations on NH-1.</p>
              </div>
            </div>

            <div className="w-full max-w-5xl pt-8">
              <div className="glass-card overflow-hidden gradient-border-glow p-5 shadow-2xl relative">
                <div className="relative aspect-[21/9] rounded-2xl bg-slate-900 overflow-hidden flex items-center justify-center">
                  <div className="absolute inset-0 bg-slate-950/70 z-10 flex flex-col items-center justify-center text-center p-12 space-y-8">
                    <MapPin className="w-20 h-20 text-primary animate-bounce" />
                    <div>
                      <h4 className="text-3xl font-black text-white">Lovely Professional University</h4>
                      <p className="text-lg text-slate-450 mt-3">Phagwara, Punjab, India</p>
                    </div>
                    <a
                      href="https://maps.google.com/?q=Lovely+Professional+University"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center justify-center gap-3 py-5 px-10 bg-gradient-to-r from-primary to-secondary hover:opacity-90 text-white rounded-2xl font-bold text-base shadow-xl transition-all hover:scale-105"
                    >
                  ...
                  <div className="absolute inset-0 opacity-15"
                    style={{ backgroundImage: 'radial-gradient(rgba(79, 124, 255, 0.4) 2px, transparent 2px)', backgroundSize: '32px 32px' }}
                  />
                </div>
              </div>
            </div>
              ...
              return (
                ...
                >
                  <button
                    ...
                    className="w-full p-6 sm:p-8 flex items-center justify-between text-left gap-8"
                  >
                    <h4 className="text-lg md:text-xl font-bold text-white pr-4">{item.q}</h4>
                    <ChevronDown
                      className={`w-8 h-8 text-slate-500 flex-shrink-0 transition-transform duration-300 ${
                  ...
                  >
                    <div className="p-6 sm:p-8 bg-bg-primary/30 text-base text-slate-400 leading-relaxed text-left">
                      {item.a}
                    </div>
                  </div>
                </div>
      ...
      <section className="section-py relative z-10 overflow-hidden border-t border-white/5">
        ...
        <div className="w-full max-w-[1280px] mx-auto px-6 sm:px-8 md:px-16 lg:px-20 relative z-10 pb-20">
          <div className="glass-card p-8 sm:p-12 md:p-24 text-center max-w-5xl mx-auto relative overflow-hidden bg-gradient-to-r from-surface/80 to-slate-900/80 border border-white/5 flex flex-col items-center">
            <div className="absolute top-0 inset-x-0 h-2 bg-gradient-to-r from-primary via-secondary to-primary animate-gradient-shift" />

            <div className="max-w-3xl mx-auto space-y-12 flex flex-col items-center">
              <Trophy className="w-24 h-24 text-warning mx-auto animate-bounce" />
              
              <div className="space-y-8 flex flex-col items-center">
                <h2 className="text-4xl md:text-6xl font-black text-white tracking-tight leading-tight">Join the Hacking Nexus!</h2>
                <p className="text-slate-350 text-lg md:text-xl leading-relaxed max-w-2xl mx-auto">
              ...
              <div className="flex flex-wrap justify-center gap-8 py-6">
                {[
                  ...
                  <div key={i} className="flex items-center gap-3 text-base font-semibold text-slate-300">
                    <span className="w-2.5 h-2.5 rounded-full bg-success flex-shrink-0 shadow-[0_0_12px_rgba(34,197,94,0.6)]" />
                    <span>{item}</span>
                  </div>
                ))}
              </div>
              ...
              <div className="pt-10 w-full flex justify-center">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-3 px-10 py-5 bg-gradient-to-r from-primary to-secondary hover:opacity-95 text-white rounded-2xl font-bold text-lg shadow-2xl shadow-primary/20 hover:shadow-primary/40 hover:scale-[1.02] transition-all duration-300"
                >
              ...
              <div className="pt-16 mt-6 border-t border-white/5 flex flex-col sm:flex-row items-center justify-center gap-14 w-full">
                <div className="flex flex-col items-center text-center space-y-2">
                  <span className="text-[11px] text-slate-500 uppercase tracking-widest font-bold">Organizer</span>
                  <span className="text-base font-bold text-slate-200">Arvix Team</span>
                </div>
                <div className="flex flex-col items-center text-center space-y-2">
                  <span className="text-[11px] text-slate-500 uppercase tracking-widest font-bold">Support Email</span>
                  <a href="mailto:sujithlavudu@gmail.com" className="text-base font-bold text-primary hover:underline">sujithlavudu@gmail.com</a>
                </div>
                <div className="flex flex-col items-center text-center space-y-2">
                  <span className="text-[11px] text-slate-500 uppercase tracking-widest font-bold">Support Phone</span>
                  <a href="tel:+917331161928" className="text-base font-bold text-slate-200">+91-7331161928</a>
                </div>
              </div>
